...
namespace Course {
    ...
    public partial class CourseDataSet : global::System.Data.DataSet {
        ...
        public partial class НаходкиDataTable : global::System.Data.TypedTableBase<НаходкиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public НаходкиRow AddНаходкиRow(string Название, string Описание, string ФИО, string Телефон, System.DateTime Время_находки, System.DateTime Время_регистрации) {
...
namespace Course.CourseDataSetTableAdapters {
    ...
    public partial class НаходкиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Находки` WHERE ((`Код` = ?) AND ((? = 1 AND `Название` IS NULL) OR (`Название` = ?)) AND ((? = 1 AND `ФИО` IS NULL) OR (`ФИО` = ?)) AND ((? = 1 AND `Телефон` IS NULL) OR (`Телефон` = ?)) AND ((? = 1 AND `Время находки` IS NULL) OR (`Время находки` = ?)) AND ((? = 1 AND `Время регистрации` IS NULL) OR (`Время регистрации` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Находки` SET `Название` = ?, `Описание` = ?, `ФИО` = ?, `Телефон` = ?, `Время находки` = ?, `Время регистрации` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `Название` IS NULL) OR (`Название` = ?)) AND ((? = 1 AND `ФИО` IS NULL) OR (`ФИО` = ?)) AND ((? = 1 AND `Телефон` IS NULL) OR (`Телефон` = ?)) AND ((? = 1 AND `Время находки` IS NULL) OR (`Время находки` = ?)) AND ((? = 1 AND `Время регистрации` IS NULL) OR (`Время регистрации` = ?)))";
        ...
        public virtual int Fill(CourseDataSet.НаходкиDataTable dataTable) {
        ...
        public virtual CourseDataSet.НаходкиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CourseDataSet.НаходкиDataTable dataTable = new CourseDataSet.НаходкиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CourseDataSet.НаходкиDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Код, string Original_Название, string Original_ФИО, string Original_Телефон, global::System.Nullable<global::System.DateTime> Original_Время_находки, global::System.Nullable<global::System.DateTime> Original_Время_регистрации) {
        ...
        public virtual int Insert(string Название, string Описание, string ФИО, string Телефон, global::System.Nullable<global::System.DateTime> Время_находки, global::System.Nullable<global::System.DateTime> Время_регистрации) {
            if ((Название == null)) {
        ...
        public virtual int Update(string Название, string Описание, string ФИО, string Телефон, global::System.Nullable<global::System.DateTime> Время_находки, global::System.Nullable<global::System.DateTime> Время_регистрации, int Original_Код, string Original_Название, string Original_ФИО, string Original_Телефон, global::System.Nullable<global::System.DateTime> Original_Время_находки, global::System.Nullable<global::System.DateTime> Original_Время_регистрации) {
            ...
            if ((Original_Время_находки.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((System.DateTime)(Original_Время_находки.Value));
            }
            else {
            ...
            if ((Original_Время_регистрации.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((System.DateTime)(Original_Время_регистрации.Value));
            }
            else {
    ...
    public partial class СотрудникиTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(CourseDataSet.СотрудникиDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual CourseDataSet.СотрудникиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CourseDataSet.СотрудникиDataTable dataTable = new CourseDataSet.СотрудникиDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CourseDataSet.СотрудникиDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
